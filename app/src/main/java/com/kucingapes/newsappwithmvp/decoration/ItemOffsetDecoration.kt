/*
 * ItemOffsetDecoration.kt on NewsAppwithMVP
 * Developed by Muhammad Utsman on 10/10/18 12:34 PM
 * Last modified 10/10/18 12:31 PM
 * Copyright (c) 2018 kucingapes
 */

package com.kucingapes.newsappwithmvp.decoration
...
class ItemOffsetDecoration @JvmOverloads constructor(private val spacing: Int, private var displayMode: Int = -1) : RecyclerView.ItemDecoration() {
